...
{html_options id='title_advanced' name='title_advanced[]' options=$fields.title_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.title_advanced.value}
                    </td>
