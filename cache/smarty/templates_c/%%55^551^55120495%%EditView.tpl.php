...
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['title']['value'] ) && $this->_tpl_vars['fields']['title']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['title']['options'],'selected' => $this->_tpl_vars['fields']['title']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['title']['options'],'selected' => $this->_tpl_vars['fields']['title']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['title']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['title']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['title']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['title']['name']; ?>
<?php echo '");
...
<?php endif; ?><?php else: ?><?php echo $this->_tpl_vars['TITLE_READONLY']; ?>
<?php endif; ?>
...
<?php echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', true,\'Дата регистрации\' );
...
<?php echo '\' );
addToValidate(\'EditView\', \'title\', \'enum\', true,\''; ?>
